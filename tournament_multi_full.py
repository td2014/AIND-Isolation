...
from game_agent import custom_score1
...
def main():
    ...
    test_agents = [Agent(CustomPlayer(score_fn=improved_score, **CUSTOM_ARGS), "ID_Improved"),
                   Agent(CustomPlayer(score_fn=custom_score1, **CUSTOM_ARGS), "PlayerCentralityRatio"),
                   Agent(CustomPlayer(score_fn=custom_score2, **CUSTOM_ARGS), "InverseAvgOpenRadius"),
                   Agent(CustomPlayer(score_fn=custom_score3, **CUSTOM_ARGS), "CenterToPeripheralOpenRatio")]
